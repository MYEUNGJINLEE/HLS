...
global env
set CATAPULT_HOME "/usr/local/bin/Siemens_EDA/Catapult_Synthesis_2025.2_1-1197638/Mgc_home"
## Set the variable for file path prefixing 
set RTL_TOOL_SCRIPT_DIR /mnt/HDD/soc_lab_LMJ/catapultwork/git/HLS/Binary_cnn/gpt_backbone_phase3/GPTBackbonePhase3.v1/vivado_concat_vhdl
...
puts "==========================================="
set outputDir /mnt/HDD/soc_lab_LMJ/catapultwork/git/HLS/Binary_cnn/gpt_backbone_phase3/GPTBackbonePhase3.v1/vivado_concat_vhdl
...
set_property part xczu11eg-ffvb1517-1-e [current_project]
