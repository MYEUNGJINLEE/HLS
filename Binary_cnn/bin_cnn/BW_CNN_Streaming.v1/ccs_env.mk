ifeq "$(CXX_HOME)" ""
CXX_HOME                                            := /usr/local/bin/Siemens_EDA/Catapult_Synthesis_2025.2_1-1197638/Mgc_home/pkgs/dcs_gcc/usr
export CXX_HOME
endif
ifeq "$(CXX_TYPE)" ""
CXX_TYPE                                            := gcc
...
ifeq "$(QuestaSIM_Path)" ""
QuestaSIM_Path                                      := /tools/SIEMENS/QUESTASIM/2020.3_2/linux_x86_64/modeltech/bin
...
QuestaSIM_MSIM_DOFILE                               := remove_waves.do
...
Novas_NOVAS_INST_DIR                                := /tools/SYNOPSYS/VERDI/S-2021.09
export Novas_NOVAS_INST_DIR
endif
ifeq "$(Novas_VERDI_VERSION)" ""
Novas_VERDI_VERSION                                 := U-2023.03-SP1
...
ifeq "$(VCS_VCS_HOME)" ""
VCS_VCS_HOME                                        := /tools/SYNOPSYS/VCS/S-2021.09
export VCS_VCS_HOME
endif
...
ifeq "$(SCVerify_HOLD_DISABLED_INPUTS)" ""
SCVerify_HOLD_DISABLED_INPUTS                       := true
export SCVerify_HOLD_DISABLED_INPUTS
endif
...
ifeq "$(LowPower_QWAVE_USE_HDLOFFICE)" ""
LowPower_QWAVE_USE_HDLOFFICE                        := true
export LowPower_QWAVE_USE_HDLOFFICE
endif
...
Vivado_XILINX_VIVADO                                := /tools/Xilinx/Vivado/2024.1
...
ifeq "$(MODEL_TECH)" ""
MODEL_TECH                                          := /tools/SIEMENS/QUESTASIM/2020.3_2/linux_x86_64/modeltech/bin
export MODEL_TECH
endif
ifeq "$(INCL_DIRS)" ""
INCL_DIRS                                           := 
